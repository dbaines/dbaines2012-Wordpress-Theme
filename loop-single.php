...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<section id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<article class="entry-content">
						<?php the_content(); ?>
						<?php wp_link_pages( array( 'before' => '<div class="page-link">Yo, this post has pages. Crazy Town!<br />' . __( '<strong>Pages:</strong><span class="links">', 'twentyten' ), 'after' => '</span></div>' ) ); ?>
					</article><!-- .entry-content -->
                    
                    <?php 
                    if (getTemplateOption(authorinfo)) {
                    ?>
                    ...
                    <?php endif; ?>
                    <?php } // Ending db2012 author info check ?>
                    ...
                    <ul class="entry-meta-large">
                        ...
                        <?php if ( getTemplateOption(listeningto) ) : ?>
                        <li class="music">
							<?php 
