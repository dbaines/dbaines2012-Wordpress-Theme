...
<?php if ( $wp_query->max_num_pages > 1 ) : ?>
    ...
    <?php if(!getTemplateOption(loadmore)) { // If not using AJAX LoadMore, show WP-PageNavi, or default WP Navigation ?>
...
<?php if ($triggerVar) { ?>
<div class="posts-container <?php echo $triggerVar; ?>" data-id="<?php echo $triggerAttr; ?>">
<?php } else { ?>
...
<?php /* Websites */ ?>
	...
	<?php elseif ( get_post_type($postID)=='websites') :  ?>
        ...
        <article class="websiteContainer">
            ...
            <div class="webPlusOne"><g:plusone size="small" <?php if(!getTemplateOption(plusone_count)) { ?>count="false"<?php } ?> href="<?php the_permalink(); ?>"></g:plusone></div>
            <?php }	?>
...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
		...
		if(getTemplateOption(allthumbs)) {
		?>
...
<?php endwhile; // End the loop. Whew. ?>
	...
	<?php if ( get_post_type($postID) != 'websites' and get_post_type($postID) != 'artwork' and get_post_type($postID) != 'motion') :  ?>
	<?php if (  $wp_query->max_num_pages > 1 ) : ?>


    <?php if(getTemplateOption(loadmore)) { // Check for AJAX LoadMore?>
    ...
    <?php } ?>
    <?php endif; // End of max_num_pages check ?>
    <?php endif; // End of post type check ?>